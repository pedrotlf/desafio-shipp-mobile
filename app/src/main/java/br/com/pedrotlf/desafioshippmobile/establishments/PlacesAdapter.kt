...
class PlacesAdapter(
    ...
    override fun onBindViewHolder(holder: PlacesViewHolder, position: Int) {
        ...
        holder.photo = null
        establishmentsViewModel.getPlaceDetails(place.placeId){ latLng, photoMetadata ->
        ...
        holder.card?.setOnClickListener { onPlaceClicked(EstablishmentOrder(place.placeId, name.toString(), endereco, bairro, holder.photo, holder.latLng)) }
    }
}